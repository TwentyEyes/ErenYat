        ...
        <div class="col-lg-8">
          <div class="blog-details__content">
            ...
            <div class="blog-one__meta">
              <nuxt-link href="/blog/detail" class="blog-one__meta-link">By admin</nuxt-link>
              <span class="blog-one__meta-sep">.</span>
              <nuxt-link href="/blog/detail" class="blog-one__meta-link">4 Aug</nuxt-link>
              <span class="blog-one__meta-sep">.</span>
              <nuxt-link href="/blog/detail" class="blog-one__meta-link">2 comments</nuxt-link>
            </div><!-- /.blog-one__meta -->
